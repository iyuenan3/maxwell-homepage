...
<ul class="commit-items">
  ...
  <li><span class="b">对比测试</span>：与海康黑光球机进行对比测试，制定评估标准。</li>
    ...
    /* ── projects / 有趣的项目 ──────────────────────── */
    projects: [
      { perm: '-rwxr-xr-x', state: 'live',     date: '2026-05-08', slug: 'eastern-wisdom',           dir: true,  zh: '东方智慧 · 海外华人取名 SaaS',                 desc: '海外华人取名 SaaS · 4-Stage AI 流水线（八字 → 候选字 → SSE 流式生成 → 评分验证）+ 朱砂印博物馆视觉 + 双语全站 · monorepo 多 app 架构',                                       stack: 'next.js 16 · doubao · python · monorepo' },
      ...
      { perm: 'drwxr-xr-x', state: 'active',   date: '2026-04-08', slug: 'petslog',                  dir: true,  zh: 'PetsLog · 宠物健康伴侣',                       desc: 'uni-app 双端宠物健康伴侣（小程序 + H5）· 用药 / 报告 / 提醒 / 离线 · 同需求 Cursor + OpenClaw 双工具对比实现',                                                              stack: 'vue · uni-app · cursor · openclaw' },
